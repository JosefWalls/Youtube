    ...
    return (
        <div className="recommended">
            ...
            <div className="recommended_videos">
                ...
                channelImage="https://i2-prod.mirror.co.uk/incoming/article6355529.ece/ALTERNATES/s1200c/Wrestling-superstar-Hulk-Hogan.jpg"
                channel="Hogans Hulk"
                image="https://i.ytimg.com/vi/mghU6mmVqEg/maxresdefault.jpg"
                />
                <VideoCard
                title="I got a new pc!"
                views="250 views"
                timestamp="5 months ago"
                channelImage="https://i2-prod.mirror.co.uk/incoming/article6355529.ece/ALTERNATES/s1200c/Wrestling-superstar-Hulk-Hogan.jpg"
                channel="Hogans Hulk"
                image="https://thechive.com/wp-content/uploads/2019/12/person-hilariously-photoshops-animals-onto-random-things-xx-photos-25.jpg?attachment_cache_bust=3136487&quality=85&strip=info&w=400g"
                />
                <VideoCard
                title="My parents put me up for adoption!"
                views="908,927 views"
                timestamp="1 months ago"
                channelImage="https://i2-prod.mirror.co.uk/incoming/article6355529.ece/ALTERNATES/s1200c/Wrestling-superstar-Hulk-Hogan.jpg"
                channel="Hogans Hulk"
                image="https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Two_red_dice_01.svg/1200px-Two_red_dice_01.svg.png"/>
                <VideoCard
                title="I got a new pc!"
                views="250 views"
                timestamp="5 months ago"
